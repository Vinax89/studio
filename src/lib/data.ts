...
export const mockTransactions: Transaction[] = [
  ...
  {
    id: "2",
    date: Timestamp.fromDate(new Date("2024-07-14")),
    description: "Scrubs & Uniforms",
    amount: 120.5,
    currency: "USD",
    type: "Expense",
    category: "Uniforms",
  ...
  {
    id: "3",
    date: Timestamp.fromDate(new Date("2024-07-12")),
  ...
  {
    id: "5",
    date: Timestamp.fromDate(new Date("2024-07-08")),
  ...
  {
    id: "7",
    date: Timestamp.fromDate(new Date("2024-07-01")),
    description: "Bi-weekly Paycheck",
    amount: 2500.0,
    currency: "USD",
    type: "Income",
