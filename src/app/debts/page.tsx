...
const DebtCalendar = dynamic(() => import("@/components/debts/DebtCalendar"), {
  ssr: false,
});
...
export default function DebtsPage() {
  ...
  const [strategy, setStrategy] = useState<SuggestDebtStrategyOutput | null>(
    null,
  );
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Use the calendar to track due dates, and get an AI-powered plan to
          become debt-free.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 border rounded-lg">
          <div>
            ...
            <p className="text-muted-foreground">
              Let our AI analyze your debts and suggest the optimal payoff
              strategy.
            </p>
          </div>
      ...
      <div>
        ...
        {debts.length > 0 ? (
            ...
            {debts.map((debt) => (
              <DebtCard
                ...
                onUpdate={(updatedDebt) => {
                  ...
                  const debtIndex = debts.findIndex(
                    (d) => d.id === updatedDebt.id,
                  );
          ...
          <p className="text-muted-foreground">
            You haven't added any debts yet. Add one in the calendar to get
            started.
          </p>
        )}
      </div>
