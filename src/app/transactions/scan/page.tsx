...
export default function ScanReceiptPage() {
  ...
  const [analysisResult, setAnalysisResult] =
    useState<AnalyzeReceiptOutput | null>(null);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Use your camera or upload a file to automatically log a transaction.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="relative aspect-video w-full bg-muted rounded-md overflow-hidden border">
                  ...
                  {hasCameraPermission === false && (
                    <div className="absolute inset-0 flex items-center justify-center text-center p-4">
                      <p className="text-muted-foreground">
                        Camera is off or permission was denied.
                      </p>
                    </div>
                  )}
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Review the AI-extracted details and save.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {imagePreview && (
            ...
            {analysisResult && (
              <div className="space-y-4 pt-4 border-t">
                ...
                <Button onClick={saveTransaction} size="lg" className="w-full">
                  Save Transaction
                </Button>
              </div>
            )}
            ...
            {!imagePreview && !analysisResult && (
              <div className="flex flex-col items-center justify-center text-center text-muted-foreground p-6 rounded-md border-2 border-dashed h-full">
                ...
                <p className="text-sm">
                  First, provide an image to get started.
                </p>
              </div>
            )}
          </CardContent>
