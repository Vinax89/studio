  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "There was an error estimating your taxes. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Get an AI-powered estimate of your annual tax burden using 2025
          brackets.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter your income, deductions, and filing status to get a
            projection. This is not financial advice.
          </CardDescription>
        </CardHeader>
        <CardContent>
