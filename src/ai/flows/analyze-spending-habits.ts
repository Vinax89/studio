...
const AnalyzeSpendingHabitsInputSchema = z.object({
  ...
  userDescription: z
    .string()
    .describe(
      "A description of the user and their general financial situation.",
    ),
  goals: z
    .array(GoalSchema)
    .describe(
      "An array of the user's financial goals, including their self-rated importance.",
    ),
});
export type AnalyzeSpendingHabitsInput = z.infer<
  typeof AnalyzeSpendingHabitsInputSchema
>;

const AnalyzeSpendingHabitsOutputSchema = z.object({
  spendingAnalysis: z
    .string()
    .describe("An analysis of the user spending habits."),
  savingsOpportunities: z
    .string()
    .describe("Identified potential savings opportunities."),
  recommendations: z
    .string()
    .describe(
      "Personalized financial recommendations, taking goal importance into account.",
    ),
});
export type AnalyzeSpendingHabitsOutput = z.infer<
  typeof AnalyzeSpendingHabitsOutputSchema
>;
